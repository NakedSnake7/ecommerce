...
import com.ecommerce.store.dto.producto.reportes.ProductoVentaDTO;
...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("""
    	    ...
    	    WHERE o.orderStatus = com.ecommerce.store.model.OrderStatus.CREATED
    	      AND o.paymentMethod = com.ecommerce.store.model.Order.PaymentMethod.TRANSFER
    	""")
    ...
    @Query("""
            SELECT new com.ecommerce.store.dto.producto.reportes.ProductoVentaDTO(
    	        p.productName,
    	        SUM(oi.quantity)
    	    )
    	    FROM OrderItem oi
    	    JOIN oi.order o
    	    JOIN oi.producto p
    	    WHERE o.paymentStatus = com.ecommerce.store.model.PaymentStatus.PAID
